...
%The positive relative uncertainty was used to calculate the upper bound of the systematic uncertainty, whereas the negative relative uncertainty was used to calculate the lower bound.
%All uncertainties except the unfolding and the MC non-closure are assumed to be correlated, and are evaluated by comparing the \Rdptr\ distributions for the various systematic variations and the nominal \Rdptr\ distributions.
...
%	 \includegraphics[page=3, width=\textwidth]{figures/main/systematics/Summary_ChPS_dR_sys_PbPb_error}
%\end{subfigure}
%   \caption{A summary of the systematic uncertainties on \RDptr\ distributions for different track $1.0 < \pt < 1.6$ GeV and $2.5 < \pt < 4.0$ GeV \pt, for jets with \pt\ 126--158 \GeV\ , as a function of \rvar\ for different centrality bins.
%Different panels are different centrality bins.
%The uncertainties from the JES, JER, UE, and Tracking  are shown, along with the total systematic uncertainty from all sources.
%}
%      \label{fig:rdptr_sys_uncert1}
...
%\centering{
%\begin{tabular}{cc}
%	 \includegraphics[page=1, width=0.850\textwidth]{figures/main/systematics/Summary_ChPS_dR_sys_PbPb_error} 	\\
%	 \includegraphics[page=3, width=0.850\textwidth]{figures/main/systematics/Summary_ChPS_dR_sys_PbPb_error}
%\end{tabular} }
%   \caption{A summary of the systematic uncertainties on \RDptr\ distributions for different track $1.0 < \pt < 1.6$ GeV and $2.5 < \pt < 4.0$ GeV \pt, for jets with \pt\ 126--158 \GeV\ , as a function of \rvar\ for different centrality bins.
%Different panels are different centrality bins.
%The uncertainties from the JES, JER, UE, and Tracking  are shown, along with the total systematic uncertainty from all sources.
...
%\centering{
%\begin{tabular}{cc}
%	 \includegraphics[page=5, width=0.850\textwidth]{figures/main/systematics/Summary_ChPS_dR_sys_PbPb_error} 
%	 \includegraphics[page=6, width=0.850\textwidth]{figures/main/systematics/Summary_ChPS_dR_sys_PbPb_error} \\
%\end{tabular} }
%   \caption{A summary of the systematic uncertainties on \RDptr\ distributions for different track $6.3 < \pt < 10.0$ GeV and $10.0 < \pt < 25.1$ GeV, for jets with \pt\ 126--158 \GeV\ , as a function of \rvar\ for different centrality bins.
%Different panels are different centrality bins.
%The uncertainties from the JES, JER, UE, and Tracking  are shown, along with the total systematic uncertainty from all sources.
%}
%      \label{fig:rdptr_sys_uncert2}
...
%used to parameterize the efficiency corrections.
% Since this uncertainty is largely from the statistical 
