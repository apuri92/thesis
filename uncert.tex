...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[page=5, width=\textwidth]{figures/main/figures_systematics/Summary_ChPS_dR_sys_PbPb_error}
    \caption{}
    \label{fig:rdptr_sys_uncert2a}
\end{subfigure} \\
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[page=6, width=\textwidth]{figures/main/figures_systematics/Summary_ChPS_dR_sys_PbPb_error}
    \caption{}
...
%\centering{
%\begin{tabular}{cc}
%	 \includegraphics[page=1, width=0.850\textwidth]{figures/main/figures_systematics/Summary_ChPS_dR_sys_PbPb_error} 	\\
%	 \includegraphics[page=3, width=0.850\textwidth]{figures/main/figures_systematics/Summary_ChPS_dR_sys_PbPb_error}
%\end{tabular} }
%   \caption{A summary of the systematic uncertainties on \RDptr\ distributions for different track $1.0 < \pt < 1.6$ GeV and $2.5 < \pt < 4.0$ GeV \pt, for jets with \pt\ 126--158 \GeV\ , as a function of \rvar\ for different centrality bins. Different panels are different centrality bins. The uncertainties from the JES, JER, UE, and Tracking  are shown, along with the total systematic uncertainty from all sources. }
%      \label{fig:rdptr_sys_uncert1}
%\end{figure}
...
%\centering{
%\begin{tabular}{cc}
%	 \includegraphics[page=5, width=0.850\textwidth]{figures/main/figures_systematics/Summary_ChPS_dR_sys_PbPb_error} 
%	 \includegraphics[page=6, width=0.850\textwidth]{figures/main/figures_systematics/Summary_ChPS_dR_sys_PbPb_error} \\
%\end{tabular} }
...
\begin{figure}
\centerline{\includegraphics[page=1,width=1.\textwidth]{figures/main/figures_systematics/Summary_UE_RDpT_dR_sys_error}}
...
\centering{
\begin{tabular}{cc}
	 \includegraphics[width=1.\textwidth]{figures/main/figures_systematics/map_stat_gaus}
\end{tabular} }
...
\begin{figure}[h]
    \centerline{
       \includegraphics[width=0.75\textwidth]{figures/main/figures_systematics/map_stat_size}
    }
...
\begin{figure}
\centerline{\includegraphics[page=2,width=1.\textwidth]{figures/main/figures_systematics/ChPS_UE_Comparison}}
...
\begin{figure}
\centerline{\includegraphics[page=1,width=1.\textwidth]{figures/main/figures_systematics/ChPS_final_dR_PbPb_MC.pdf}}
