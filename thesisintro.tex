...
%Jets are reconstructed with the \antikt\ algorithm~\cite{Cacciari:2008qp} using a radius parameter \RFour\ over a rapidity range of $|\yjet| <$~1.3. The measurement is presented for jets with transverse momenta (\ptjet) in the 126 to 316~\GeV\ range, for charged particles with $\pT>1.6$~\GeV\ and eight successive intervals of angular distance $r$ with the following edges: 0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5, and 0.6.
%
%
