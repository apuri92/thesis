...
measured with \ptjet\ between 126~GeV and 316~GeV in following four successive intervals: 126--158, 158--200, 200--251, and 251--316~GeV. This binning was motivated by the large fake rate below 100 \GeV. An underflow bin was also needed for the unfolding procedure, and hence, the measurement starts at 126 \GeV. This binning is also used in previous heavy ion jet measurements (\cite{PhysRevC.98.024908}). Truth jets were associated with the nearest reconstructed jet using the matching of $\dR<0.2$ for the performance study and to build response matrices for the unfolding procedure. The same \dR\ matching criteria were employed in previous ATLAS HI jet analyses and are justified by a detailed performance study~\cite{Aad:12081967v1}. To prevent nearby jets from distorting the measurement of \Dptr\ distributions, 
...
\centering{
\begin{tabular}{cc}
\includegraphics[width=0.9\textwidth]{figures/main/figures_performance/jet_iso.pdf} \\
\end{tabular}}
...
%\centering{
%\begin{tabular}{cc}
%\includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/ff_data_comaparison_eta4_cent0_iso08.pdf} &
%\includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/ff_data_comaparison_eta4_cent5_iso08.pdf} \\
%\end{tabular}}
...
%\centering{
%\begin{tabular}{cc}
%\includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/RdR_126_158GeV_c0.pdf} &
%\includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/RdR_126_158GeV_c5.pdf} \\
%\includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/RdR_200_251GeV_c0.pdf} &
%\includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/RdR_200_251GeV_c5.pdf} \\ 
%\end{tabular}}
...
\begin{figure}
\centering{
\includegraphics[width=0.75\textwidth]{figures/main/figures_performance/TrkPerforPlots_5TeV_pp.pdf} }
...
\begin{figure}
\centering{
\includegraphics[width=0.75\textwidth]{figures/main/figures_performance/TrkPerforPlots_PbPb_pt4p2_10p0GeV.pdf} }
...
\begin{figure}
\centering{
\includegraphics[width=0.75\textwidth]{figures/main/figures_performance/TrkPerforPlots_PbPb_pt60_200GeV.pdf} }
...
\centering{
\begin{tabular}{cc}
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/scale_v_eta_pp.pdf} &
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/resolution_v_eta_pp.pdf} \\ 
\end{tabular}}
...
\centering{
\begin{tabular}{cc}
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/cut_flow_RecoNorm_MC_pT_4_6_jet.pdf} &
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/cut_flow_RecoNorm_MC_pT_23p7_31p5_jet.pdf} \\
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/cut_flow_RecoNorm_MC_eta_0p05_jet.pdf} &
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/cut_flow_RecoNorm_MC_eta_2p05_jet.pdf} \\
\end{tabular} }
...
\centering{
\begin{tabular}{cc}
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/PbPb_cutflow_pptight.pdf} &
\includegraphics[width=0.45\textwidth]{figures/main/figures_performance/PbPb_cutflow_pptight_tight.pdf} \\
\end{tabular} }
...
\begin{figure}[h]
\centerline{
\includegraphics[width=0.75\textwidth]{figures/main/figures_corrections/MuonPerf.pdf}
}
...
\begin{figure}[ht]
   \centerline{
      \includegraphics[width=0.9\textwidth]{figures/main/figures_corrections/eff_cent_trketa_PbPb_ppTight.pdf}
   }
...
\begin{figure}[ht]
   \centerline{
      \includegraphics[width=0.55\textwidth]{figures/main/figures_corrections/eff_cent_trketa_pp_ppTight.pdf}
   }
...
\begin{figure}[ht]
   \centerline{
      \includegraphics[width=0.9\textwidth]{figures/main/figures_corrections/eff_centrality_jetpt_jety0_ppTight.pdf}
   }
...
\begin{figure}[ht]
   \centerline{
      \includegraphics[width=0.9\textwidth]{figures/main/figures_corrections/eff_centrality_jetpt_jety1_ppTight.pdf}
   }
...
\begin{figure}[ht]
   \centerline{
      \includegraphics[width=0.55\textwidth]{figures/main/figures_corrections/Trk_eff_v_pt_r005f_Tight_mcprob0p3_CX_Injet_0p0_0p3_pp_5p02.pdf}
   }
...
where the rate increases again.  In \pbpb\ collisions, the ``fake'' rate also includes tracks which are from the underlying event from the real collisions into which the jet is overlaid.  The rate of these underlying event tracks increases with decreasing \pttrk\ and increasing collision centrality. The contribution from UE is negligible for tracks with \pT\ above 10 GeV as no centrality dependence is seen. The Fig.~\ref{fig:fakeratepbpb} excludes the very low \pT\ region where the distribution would be completely dominated by the UE. The size of the UE is then presented further in Fig.~\ref{fig:UEimpact_r2}-\ref{fig:UEimpact_r6}. To separate the contribution of UE tracks (see section~\ref{sec:cuts_UE}) from the fake tracks in \PbPb\ collisions and cross-check the centrality dependence of the fake rate, 0.2M MB \PbPb\ fully reconstructed HIJING MC~\cite{Wang:1991hta} events was used. The HIJING MC generator is capable of simulating global properties of HI collisions. The estimated fake rate of tracks associated with jets with $\pT>40$ GeV is at the level of 1\% and it exhibits similar behavior as observed in Fig.~\ref{fig:fakeratepbpb}. No significant dependence of the fake rate on the collision centrality was found~\cite{PhysRevC.98.024908}.
  ...
  \centerline{
  \begin{tabular}{cc}
  \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rates/FakesEta_pp_5p02_r003_Tight_mcprob0p3_JZ2_jetpt_2.pdf} &
  \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rates/FakesEta_pp_5p02_r003_Tight_mcprob0p3_JZ2_jetpt_3.pdf} \\
    \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rates/FakesEta_pp_5p02_r003_Tight_mcprob0p3_JZ2_jetpt_4.pdf} &
    \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rates/FakesEta_pp_5p02_r003_Tight_mcprob0p3_JZ3_jetpt_5.pdf} \\
      \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rates/FakesEta_pp_5p02_r003_Tight_mcprob0p3_JZ3_jetpt_6.pdf} &
  \end{tabular}}
  ...
  \begin{figure}[ht]
     \centerline{
	\begin{tabular}{cc}
	   \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rate_pt_125GeV.pdf} &
	   \includegraphics[width=0.45\textwidth]{figures/main/figures_corrections/fake_rate_pt_251GeV.pdf} \\
	\end{tabular}
     }
  ...
  \begin{figure}[ht]
  \centerline{
	   \includegraphics[width=1.\textwidth]{figures/main/figures_performance/fake_rate_hijingMB.pdf}
	   }
...
\centerline{
\begin{tabular}{ccc}
\includegraphics[width=0.7\textwidth]{figures/main/figures_UE/eta_phi_map_trk2_dR0.pdf} \\
\includegraphics[width=0.7\textwidth]{figures/main/figures_UE/eta_phi_map_trk2_dR5.pdf} \\
\includegraphics[width=0.7\textwidth]{figures/main/figures_UE/eta_phi_map_trk2_dR9.pdf} \\
\end{tabular}}
\caption{
...
\begin{figure}[ht]
     \centerline{
        \includegraphics[width=0.9\textwidth]{figures/main/figures_UE/UE_v_dR_pt1GeV.pdf}
     }
...
\begin{figure}[ht]
     \centerline{
        \includegraphics[width=0.45\textwidth]{figures/main/figures_UE/cone_grid.pdf}
     }
...
\begin{figure}[ht]
     \centerline{
        \includegraphics[width=0.9\textwidth]{figures/main/figures_UE/cone_stats}
     }
...
\begin{figure}[ht]
\centerline{ \includegraphics[width=0.45\textwidth]{figures/main/figures_UE/eta_correction.pdf} }
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=2,width=1.\textwidth]{figures/main/figures_UE/UE_factors.pdf} \\
}
\caption{
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=6,width=1.\textwidth]{figures/main/figures_UE/UE_factors.pdf} \\
}
\caption{
...
\begin{figure}
\centerline{\includegraphics[page=2,width=1.\textwidth]{figures/main/figures_UE/UE_x_ratio_c0}}
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=1,width=1.\textwidth]{figures/main/figures_UE/UE_factors_r.pdf} \\
}
\caption{
...
\begin{figure}[ht]
\centerline{
 \includegraphics[page=2,width=0.85\textwidth]{figures/main/figures_UE/ChPS_B2S_PbPb_data.pdf} \\
}
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=6,width=0.8\textwidth]{figures/main/figures_UE/ChPS_B2S_PbPb_data.pdf} \\
}
 \caption{Ratio between the raw \Dptr\ distributions before and after the UE 
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=11,width=0.8\textwidth]{figures/main/figures_UE/ChPS_B2S_PbPb_data.pdf} \\
}
 \caption{Ratio between the raw \Dptr\ distributions before and after the UE 
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=0.9\textwidth]{figures/main/figures_corrections/resp_matrix_jet_PbPb_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=0.55\textwidth]{figures/main/figures_corrections/resp_matrix_jet_pp_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=0.9\textwidth]{figures/main/figures_corrections/spect_closure_PbPb_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=0.55\textwidth]{figures/main/figures_corrections/spect_closure_pp_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=1.0\textwidth]{figures/main/figures_corrections/resp_matrix_ChPS_PbPb_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=1.0\textwidth]{figures/main/figures_corrections/resp_matrix_ChPS_pp_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{figures/main/figures_corrections/trk_res_eta_ppTight.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{figures/main/figures_corrections/trk_res_phi_ppTight.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/ShapeResponse2D_PbPb.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/ShapeResponse2D_pp.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/RatioProj_PbPb}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/RatioProj_pp}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/RespPurity_PbPb}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/RespEfficiency_PbPb}
...
The robustness of this correction can be validated by constructing \Dptr\ distributions using a coarser \pt\ binning (entire analysis chain is re-done) and comparing them to a summation of the individually unfolded narrow bins. This comparison can be seen in Fig.\ref{fig:MergedBinCheck}, for $1 < \pt < 4$ GeV, $126 < \ptjet < 158$ GeV,  for 0-10\%. central \pbpb\ and \pp\ collisions, and is seen to be unity.
 ...
 \begin{figure}
	 \includegraphics[width=0.95\textwidth]{figures/main/figures_general/MergedBinCheck.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=1, width=0.9\textwidth]{figures/main/figures_corrections/TruthProj_pp}
...
\begin{figure}[ht]
   \centerline{
      \begin{tabular}{c}
	\includegraphics[page=5, width=0.5\textwidth]{figures/main/figures_corrections/evol_pp_MC.pdf}
	\includegraphics[page=5, width=0.5\textwidth]{figures/main/figures_corrections/evol_pp_data.pdf}
   \end{tabular}
   }
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=5, width=0.85\textwidth]{figures/main/figures_corrections/evol_PbPb_MC.pdf}
}
...
\begin{figure}[ht]
\centerline{
\includegraphics[page=5, width=0.85\textwidth]{figures/main/figures_corrections/evol_PbPb_data.pdf}
}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=1.0\textwidth]{figures/main/figures_corrections/ChPS_final_PbPb_MC.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[page=5, width=0.55\textwidth]{figures/main/figures_corrections/ChPS_final_pp_MC.pdf}
